...
(function() {
  jQuery(function() {
    $('.actions').hide;
    return $('.comment').hover((function() {
      return $(this).find('.actions').fadeIn(150);
    }), (function() {
      return $(this).find('.actions').fadeOut(150);
    }));
  });
...
(function() {
  jQuery(function() {
    ...
    $('#followers').click(function() {
      ...
      return $('.followings_avatars').hide();
    });
    return $('#followings').click(function() {
      this.preventDefault;
      $('.followers_avatars').hide();
      return $('.followings_avatars').show();
    });
  });
